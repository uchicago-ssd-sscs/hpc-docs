# SSCS New Cluster Documentation

Welcome to the Social Sciences Computing Service's (SSCS) HPC Cluster user guide!

This site serves as the central reference for accessing and utilizing SSCS computing resources at the University of Chicago — covering everything from initial setup and job submission to software environments and data transfer. 

## How to Use the SSCS Cluster
...
Stay up to date with cluster maintenance windows, new hardware, and software updates.

---

For support, contact us at [ssc-server-support@lists.uchicago.edu](mailto:ssc-server-support@lists.uchicago.edu).